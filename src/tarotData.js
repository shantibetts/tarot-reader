const tarotData = [
	...
	{
		name: `the-empress`,
		summary: `Can represent pregnancy, the experience of mothering, or your relationship with your own mother. Have patience and avoid making rash decisions. Be receptive to change and keep an eye on your temper when things don't progress as you expected.`,
	...
	{
		name: `death`,
		summary: `Something is coming to an end or has run its course. Letting go can be painful and the saying "cwhat doesn't kill you makes you stronger"d is apt. This change is necessary and your capacity to accept it will make it easier to endure. Turn to face a new future, a new reality knowing new opportunities are available to you.`,
	...
	},
	{
		...
		full_meaning: `It is time to deal with the situation rather than continue be controlled by it. If it is self-destructive or addictive behaviour, it is time to open up and be honest "3 seek support and guidance where appropriate. Likewise, if the Subject feels bound by a long held secret, maybe it is time to bring it into the open, so they can be free of the burden. The message in this card is to admit to these binds, and make effort to overcome them, in order to be able to move on to a lighter way of life.`,
	...
	{
		name: `seven-of-cups`,
		summary: `You have a lot going on in key relationships when the Seven of Cups appears. You're likely to have a number of different options or ways to move forward. The Seven of Cups also hints that you'll soon need to commit to just one of these options "3 think carefully, choose wisely!`,
		full_meaning: `The Subject's love life may be a bit "8up in the air' at the moment. It might be that the relationship doesn't seem satisfying enough to the Subject and they need to think carefully about what they need. The mood of this card is not negative, though, so there is clearly food for thought about which is the best way forward. The Subject needs to start working out what is, and isn't, attractive, feasible or realistic for them within this relationship.`,
	...
	{
		name: `seven-of-wands`,
		summary: `The Seven of Wands shows that enthusiasm or motivation for your journey has waned. Perhaps you're finding it difficult to stay focussed and committed to your goal. Revisit plans objectively to see where alterations could reignite your creative passion and spur you on. A change is as good as a break "3 so the saying goes.`,
		full_meaning: `The Subject really needs to think this through; a decision has to be taken regarding this issue "3 should they come away from this relationship/situation?  Or should they make a real effort to change their attitude and inject some enthusiasm back into it?`,
