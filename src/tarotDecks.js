const tarotDecks = [
	{
		urls: {
			url: 'https://www.sacred-texts.com/tarot/pkt/img/',
			urlAppend: '.jpg'
		},
		cardPreviews: [
			{
				name: 'Verso',
				name_short: 'verso',
				url: 'https://www.sacred-texts.com/tarot/pkt/img/verso.jpg'
			},
			{
				name: 'The Magician',
				name_short: 'ar01',
				url: 'https://www.sacred-texts.com/tarot/pkt/img/ar01.jpg'
			}
		],
		name: 'Rider-Waite-Smith',
		descriptionShort:
			'The Rider-Waite-Smith deck, the classic Tarot deck from the early 1900s',
